...
// Custom App Logo: represents connection, dialogue, and the Chilean star
export const ConectaChileLogo = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" {...props}>
        <path fill="currentColor" d="M50 0a50 50 0 1050 50A50 50 0 0050 0zm0 90a40 40 0 1140-40 40 40 0 01-40 40z"/>
        <path fill="currentColor" d="M50 22.5l4.76 14.63h15.4l-12.46 9.04 4.76 14.63L50 51.76l-12.46 9.04 4.76-14.63-12.46-9.04h15.4z"/>
    </svg>
);
...
export const SpeakerphoneIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
