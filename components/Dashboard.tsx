                ...
                <div className="border-t border-slate-200 dark:border-slate-700 pt-4">
                    <dl className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4 text-sm">
                        ...
                        <div className="col-span-1 md:col-span-2">
                            ...
                            <dd className="text-slate-600 dark:text-slate-400">Analizar, debatir y argumentar sobre problemáticas contemporáneas de la sociedad chilena, abordando su relevancia y complejidad desde múltiples perspectivas (legal, social, cultural y ética), e integrando herramientas de análisis literario y digital para construir una postura crítica fundamentada.</dd>
                        </div>
                        <div className="col-span-1 md:col-span-2">
